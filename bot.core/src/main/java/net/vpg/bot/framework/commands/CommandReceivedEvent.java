...
public class CommandReceivedEvent implements Sender {
    ...
    public CommandReceivedEvent(GuildMessageReceivedEvent e, String[] args, BotCommand command, String prefix) {
        this(e.getJDA(),
            e.getMessageIdLong(),
            e.getChannel(),
            e.getGuild(),
    ...
    public static void run(GuildMessageReceivedEvent e, String[] args, BotCommand command, String prefix) {
